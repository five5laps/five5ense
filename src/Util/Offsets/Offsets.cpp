...
void CUtil_Offsets::Initialize()
{
	...
	GETPATT(C_BaseEntity_EstimateAbsVelocity, "client.dll", "55 8B EC 83 EC 0C 56 8B F1 E8 ? ? ? ? 3B F0 75 2B 8B CE", "55 8B EC 83 EC 0C 56 8B F1 E8 ? ? ? ? 3B F0 75 2B 8B CE", 0x0, 0x0);
	GETPATT(CEntitySphereQuery, "client.dll", "55 8B EC 83 EC 14 D9 45 0C", "55 8B EC 83 EC 14 D9 45 0C", 0x0, 0x0);
