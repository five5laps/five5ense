...
{
public:
	NETVAR(m_vInitialVelocity, Vector, "CTFBaseRocket", "m_vInitialVelocity");
	NETVAR(m_vecOrigin, Vector, "CTFBaseRocket", "m_vecOrigin");
	NETVAR(m_angRotation, Vector, "CTFBaseRocket", "m_angRotation");
...
public:
	...
	{
		static int nOffset = H::NetVar.Get("CTFGrenadePipebombProjectile", "m_iType") + 4;
