...
#include "../Includes/tf_shareddefs.h"
...
public:
	...
	void EstimateAbsVelocity(Vector& vel) {
		...
		//reinterpret_cast<void(__thiscall*)(void*, Vector&)>( H::NetVar.Get() U::Offsets::C_BaseEntity_EstimateAbsVelocity.Get())(this, vel);
	}
	...
	Vector GetCenter()
	{
		...
		return m_vecOrigin() + Vector(0.0f, 0.0f, (vMin.z + vMax.z) / 2.0f);
	}
	...
	__inline Vector GetVelocity() {
		static auto FN = reinterpret_cast<void(__thiscall*)(C_BaseEntity*, Vector&)>(U::Pattern.Find("client.dll", "55 8B EC 83 EC ? 56 8B F1 E8 ? ? ? ? 3B F0"));
		Vector v;
		FN(this, v);
		return v;
	}
